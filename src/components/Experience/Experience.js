      ...
      <div className="history-tl-container">
        <ul className="tl">
          ...
          <li className="tl-item" ng-repeat="item in retailer_history">
            ...
            <div className="item-detail">
            <br />
                  I was stuck in Nepal for the entirety of my freshman year owing to COVID-19; I made the best of it by returning to F1Soft. I: <br /><br />
          ...
          <li className="tl-item" ng-repeat="item in retailer_history">
            ...
            <div className="item-detail">
              <br />
              This was my first software engineering internship, right after high school. I:<br /><br />
